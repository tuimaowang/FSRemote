...
if(_webrtc_source_root)
    set(WEBRTC_INCLUDE_DIRS
        ...
        #"${_webrtc_source_root}/buildtools/third_party/libc++" #这两个msvc不认识
...
set(_webrtc_candidates
    ...
    #"${WEBRTC_ROOT}/src/out/uu_release/obj/api/field_trials.lib" #这个不是lib 是tlog壳子

    #ai替换
    "${WEBRTC_ROOT}/src/out/uu_release/obj/api/field_trials/field_trials.obj"
    "${WEBRTC_ROOT}/src/out/uu_release/obj/api/enable_media/enable_media.obj"
    ...
    "${WEBRTC_ROOT}/src/out/uu_release/obj/api/video_codecs/rtc_software_fallback_wrappers/video_decoder_software_fallback_wrapper.obj"
